        ...
        <div className="flex-1 bg-[#0a0e13] flex flex-col">
            ...
            <div className="flex-1 overflow-auto px-8 py-6">
                {loading ? (
                    ...
                    <div className="text-gray-400 text-center py-8">No voice agents yet. Click "Add" to create one.</div>
                ) : (
                    <div className="bg-[#141b24] rounded-lg border border-gray-800 overflow-hidden">
                        {/* Table Header */}
                        <div className="grid grid-cols-[2fr,1fr,1fr,auto] gap-4 px-6 py-3 bg-[#0f1419] border-b border-gray-800">
                        ...
                        {agents.map((agent) => (
                            <div
                                key={agent.id}
                                className="grid grid-cols-[2fr,1fr,1fr,auto] gap-4 px-6 py-4 border-b border-gray-800 last:border-b-0 hover:bg-gray-800/30 transition-colors"
                            >
                                {/* Name Column */}
                                ...
                                {/* Created Column */}
                                <div className="flex items-center text-sm text-gray-300 whitespace-pre-line">
