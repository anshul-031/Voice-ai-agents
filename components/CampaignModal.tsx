                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select id="status" value={status} onChange={e => setStatus(e.target.value as 'running' | 'stopped' | 'completed')} className="w-full px-4 py-2.5 bg-[#0a0e13] border border-gray-700 rounded-lg text-white focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500">
