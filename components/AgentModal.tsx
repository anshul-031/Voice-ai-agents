...
export default function AgentModal({ isOpen, onClose, agent, onSuccess }: AgentModalProps) {
    ...
    const [ttsModel, setTtsModel] = useState('Sarvam Voice Manisha')
    ...
    useEffect(() => {
        if (agent) {
            ...
            setTtsModel(agent.ttsModel || 'Sarvam Voice Manisha')
        } else {
            setTitle('')
            setPrompt('')
            setLlmModel('Gemini 1.5 Flash')
            setSttModel('AssemblyAI Universal')
            setTtsModel('Sarvam Voice Manisha')
        }
    }, [agent, isOpen])
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <select
                                ...
                                className="w-full px-4 py-2.5 bg-[#0a0e13] border border-gray-700 rounded-lg text-white focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500"
                            >
                                <option value="Sarvam Voice Manisha">Sarvam Voice Manisha</option>
                                <option value="Sarvam Voice Meera">Sarvam Voice Meera</option>
                                <option value="Sarvam Voice Ravi">Sarvam Voice Ravi</option>
                                <option value="Sarvam Voice Arjun">Sarvam Voice Arjun</option>
                            </select>
                        </div>
                    </div>
